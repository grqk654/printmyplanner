  ...
  return (
    <div style={{ maxWidth: 680, margin: '0 auto', padding: '40px 24px' }}>
      ...
      <div style={{ border: `2px solid ${theme.mid}`, borderRadius: 12, padding: '20px 24px', marginBottom: 24, background: theme.pale, position: 'relative' }}>
        <div style={{ position: 'absolute', top: -12, left: '50%', transform: 'translateX(-50%)', background: theme.main, color: '#EAF3DE', fontSize: 10, fontWeight: 600, padding: '4px 14px', borderRadius: 20, letterSpacing: '0.08em', textTransform: 'uppercase', whiteSpace: 'nowrap' }}>Best for iPad · GoodNotes</div>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
          <div>
            <div style={{ fontSize: 15, fontWeight: 500, color: '#1a1a14', marginBottom: 4 }}>Digital GoodNotes planner</div>
            <div style={{ fontSize: 13, color: '#6B6B5E' }}>Beautiful PDF optimized for iPad + Apple Pencil</div>
          </div>
        ...
        <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 16px' }}>
          {['4-page premium PDF with styled cover','Works in GoodNotes, Notability, Goodnotes 6','Color-matched to your chosen theme','Instant download + email delivery'].map(f => (
      ...
      {status === 'success' && (
        <div>
          ...
          <div style={{ background: '#EAF3DE', border: '1px solid #C0DD97', borderRadius: 10, padding: '16px 20px', marginBottom: 24, textAlign: 'left' }}>
            <div style={{ fontSize: 12, fontWeight: 600, color: '#2D5A1B', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 10 }}>How to open in GoodNotes</div>
    ...
    <div style={{ maxWidth: 1100, margin: '0 auto', padding: '56px 40px' }}>
      <div style={{ textAlign: 'center', marginBottom: 48 }}>
        ...
        <p style={{ fontSize: 16, color: '#6B6B5E', maxWidth: 520, margin: '0 auto 24px', lineHeight: 1.65 }}>
          Beautiful PDF planners designed for iPad and GoodNotes. Enter your name, choose your color, and download instantly.
        </p>
        <div style={{ display: 'inline-flex', gap: 32, background: '#F5FAF0', border: '1px solid #C0DD97', borderRadius: 12, padding: '14px 28px' }}>
          {['Works in GoodNotes & Notability','Instant download after payment','4-page premium PDF','Styled to your color theme'].map(f => (
            ...
            <div key={id} style={{ background: 'white', border: '1px solid #E8E4D8', borderRadius: 14, overflow: 'hidden', transition: 'all 0.2s' }}
              ...
              <div style={{ borderTop: '1px solid #F0EDE0', padding: '14px 20px', background: '#FAFAF8' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                  <div style={{ fontSize: 11, color: '#8a8a7a' }}>Digital PDF · GoodNotes</div>
